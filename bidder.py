        ...
        if menu == "0":
            ...
            if r == "Please enter your value":
                ...
                if check == "y":
                    ...
                    store_contact = contract.functions.openBid(name, value, h_x,h_y,b).buildTransaction({"chainId": 1337, "gasPrice": web3.eth.gas_price, "from": address, "nonce": web3.eth.getTransactionCount(address)})
                    signed_tx = web3.eth.account.signTransaction(store_contact, private_key='baf1ca4073aa8c9abc95315d53cc58d611ad43becb451615d291f80f1b08660b')
            ...
            if r == "You are the winner":
                ...
                res = contract.functions.retrieveProof(name).call() 
                print("Received the proof")
                ans = verifying((res[1], res[2]), (res[3], res[4]),(res[5], res[6]), (res[7], res[8]), res[9], res[10], res[11], ast.literal_eval(res[12]), (res[13], res[14]))
                if ans == True:
